...
My short-term goal is to develop novel machine learning methods and graph algorithms, with non-trivial theoretical guarantees to resolve practical computational problems (especially on social sciences, genomics, biomedicine). My long-term goal is to build on the intersection between graph neural networks, classical information theory and network coding theory, all of whose architectures are sharing very similar network structures. 
